# Cardinal Shift scheduling engine
...
The engine will be deterministic with versioned inputs, locked human decisions, hard/soft constraints, compliance validation, fairness scoring, and explainable results. LLM use is limited to interpretation and summaries, never authorization or publication.
