...
Target WCAG 2.2 AA with keyboard-first workflows, skip links, semantic landmarks, visible focus, table alternatives to grids, reduced motion, reduced transparency, responsive reflow, axe tests, keyboard Playwright flows, and manual review checklists.
