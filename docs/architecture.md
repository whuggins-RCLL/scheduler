...
Use Next.js App Router for the web shell, Firebase Authentication for Google sign-in, Cloud Firestore for tenant-scoped operational data, Firebase Admin SDK for privileged seeding and future Cloud Functions, and Firestore rules as the first server-enforced authorization boundary.
